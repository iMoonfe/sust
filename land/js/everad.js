...
(function () {
    ...
    function initiate() {
        ...
        function checkCode(event) {
            ...
            if (code.length === 15) {
                msg.innerHTML = 'This code is correct. Thank you for choosing our products!';
            }
            else if (code.length === 0) {
                msg.innerHTML = 'Please, enter the code.';
            } else {
                msg.innerHTML = 'Unfortunately, this code was not found! Most likely, you purchased a fake product.';
            }
        }
